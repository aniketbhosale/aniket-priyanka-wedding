...
$(document).ready(function() {
  ...
  if( $('#countdown').length ) {
    ...
    var countDownDate = Date.parse('17 Aug 2018 15:30:00');
    ...
    var x = setInterval(function() {
      ...
      document.getElementById('countdown').innerHTML =
        "<ul>" +
        "<li>" + "<h2 style='color: lavenderblush'>" + days + "</h2>" + "<h4>days</h4>" + "</li>" +
        "<li>" + "<h2 style='color: lavenderblush'>" + hours + "</h2>" + "<h4>hours</h4>" + "</li>"+
        "<li>" + "<h2 style='color: lavenderblush'>" + minutes + "</h2>" + "<h4>min</h4>" + "</li>"+
        "<li>" + "<h2 style='color: lavenderblush'>" + seconds + "</h2>" + "<h4>sec</h4>"+"</li>"+
        "</ul>";
